...
class ImageEncoder(nn.Module):
    ...
    def __init__(self, device):
        ...
        self.encoder, _ = clip.load("ViT-B/32", device= device, jit = False)   # loads already in eval mode
    ...
    def forward(self, x, predict=False):
        ...
        if predict:
            ...
            image_attn_blocks = list(dict(self.encoder.visual.transformer.resblocks.named_children()).values())
