...
from lightning import Self_training
import opts
import datetime
...
def self_training(args, selfe_mode, iteration, checkpoint_cb):#, wan_logger):
    ...
    model = Self_training.load_from_checkpoint("ckpts/2022-07-07_11:03:06/epoch=05-val_loss=2.15.ckpt", strict=False, hparams=args)
