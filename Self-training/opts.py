...
def get_args():
    ...
    optim_args.add_argument('--iteration', type=int, default=1, help='The number of iteration for self-training')
    ...
    data_args.add_argument('--captioning_pth', type=str, default=None, help='Directory of captioning dataset path')
    ...
    model_args.add_argument("--selfe_mode", type=str, default= None, help="Self-e mode Teacher or Student")
